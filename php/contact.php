...
if (!validarVariable($nombre) || !validarVariable($tel) || !validarVariable($mail)  || !validarVariable($pax) || !validarVariable($hora)) {
  mandarError("1");
}

$correo_nuevo = new Correo("info@elperegrinocabo.com", $nombre.' ha enviado un nuevo mensaje');
...
$correo_nuevo->agregarCampos("Hora de reserva: ", $hora);
